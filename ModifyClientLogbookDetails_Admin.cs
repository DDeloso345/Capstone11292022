...
namespace Capstone
{
    public partial class ModifyClientLogbookDetails_Admin : Form
    {
        ...
        public ModifyClientLogbookDetails_Admin()
        {
            InitializeComponent();
        }

        private void ModifyClientLogbookDetails_Admin_Load(object sender, EventArgs e)
        {
            UpdateBinding();
            ComboBoxSel();
        }
        ...
        private void logbk_del_btn_Click(object sender, EventArgs e)
        {
            sql.DeleteLogbookData(idtxt.Text);
            UpdateBinding();
            clear();
        }
