...
namespace Capstone
{
    public partial class Admin_DashboardUI : Form
    {
        ...
        public void Admin_DashboardUI_Load(object sender, EventArgs e)
        {
            Notif();
        }
        public void Notif() {
        ...
        public void GetFirstName(string username, string password)
        {
            ...
            firstnametxt.Text = Properties.Settings.Default.ad_dash_firstname;
        }
        public void GetMiddleName(string username, string password)
        {
            adda.MiddleName(username, password);
            middlenametxt.Text = Properties.Settings.Default.ad_dash_middlename;
        }
        public void GetLastName(string username, string password)
        {
            adda.LastName(username, password);
            lastnametxt.Text = Properties.Settings.Default.ad_dash_lastname;
        }
        ...
        public void GetEmail(string username, string password)
        {
            ...
            emailtxt.Text = Properties.Settings.Default.ad_dash_emailad;
        }
        private void Admin_DashboardUI_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            Admin_LibrarianUI a = new Admin_LibrarianUI();
        }

        private void missingbk_Click(object sender, EventArgs e)
        {
