...
namespace Capstone
{
    public partial class Staff_BackupAndRestore : Form
    {
        public Staff_BackupAndRestore()
        {
            InitializeComponent();
            CheckBoxEnableDisable();
        }

        private void Staff_BackupAndRestore_Load(object sender, EventArgs e)
        {
            ...
            backup_directory_txtbox3.Text = Properties.Settings.Default.backupdirectory3;
            backup_directory_txtbox4.Text = Properties.Settings.Default.backupdirectory4;
            backup_directory_txtbox5.Text = Properties.Settings.Default.backupdirectory5;
            checkbox_bckup_loc3.Checked = Properties.Settings.Default.chkboxbackupdir3;
            checkbox_bckup_loc4.Checked = Properties.Settings.Default.chkboxbackupdir4;
            checkbox_bckup_loc5.Checked = Properties.Settings.Default.chkboxbackupdir5;
        }
        ...
        private void Staff_BackupAndRestore_FormClosing(object sender, FormClosingEventArgs e)
        {
            Properties.Settings.Default.backupdirectory1 = backup_directory_txtbox1.Text;
            Properties.Settings.Default.backupdirectory2 = backup_directory_txtbox2.Text;
            Properties.Settings.Default.backupdirectory3 = backup_directory_txtbox3.Text;
            Properties.Settings.Default.backupdirectory4 = backup_directory_txtbox4.Text;
            Properties.Settings.Default.backupdirectory5 = backup_directory_txtbox5.Text;
            Properties.Settings.Default.chkboxbackupdir3 = checkbox_bckup_loc3.Checked;
            Properties.Settings.Default.chkboxbackupdir4 = checkbox_bckup_loc4.Checked;
            Properties.Settings.Default.chkboxbackupdir5 = checkbox_bckup_loc5.Checked;
