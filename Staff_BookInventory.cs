...
namespace Capstone
{
    public partial class Staff_BookInventory : Form
    {
        ...
        public Staff_BookInventory()
        {
            InitializeComponent();
        }

        private void Staff_BookInventory_Load(object sender, EventArgs e)
        {
            UpdateBinding();
            ComboBoxSel();
        }
        ...
        private void auth_selaction_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                bi_cmd.CompareAndInsertAuth(authornotxt.Text, authortxt.Text);
        ...
        {
            bkinvtimer.Start();
            SelectBKINVAuthorInfo_Staff s = new SelectBKINVAuthorInfo_Staff();
            s.Show();
        }
        ...
        {
            bkinvtimer.Start();
            SelectBKINVPublisher_Staff s = new SelectBKINVPublisher_Staff();
            s.Show();
        }
        ...
        {
            bkinvtimer.Start();
            SelectBKINVSource_Staff s = new SelectBKINVSource_Staff();
            s.Show();
        }
